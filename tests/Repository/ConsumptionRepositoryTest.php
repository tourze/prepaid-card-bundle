...
class ConsumptionRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = new ConsumptionRepository($this->managerRegistry);
    }

    public function testRepositoryInstantiation(): void
    {
        $this->assertInstanceOf(ConsumptionRepository::class, $this->repository);
    }
